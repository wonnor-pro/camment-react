...
class PostsBase extends React.Component {
    ...
    readModule = () => {
        ...
        //     coursesRef.doc(obj.course_id).set({
                    ...
                    <div id="review">
                        <div className="tab">
                            ...
                            {this.division.map((value, index) => {
                                return (
                                    <button className="tablinks" id={value} onMouseOver={this.openModule}
                        ...
                        {this.division.map((value, index) => {
                            return (
                                <div id={value} className="tabcontent" style={{display: this.dispSwitch[value]}}>
                                    <div id="post-lists">
                                        {this.coursesList[value].map((value, index) => {
                                            return (
                                                <div className="post-record">
                                                    <p className="course-id">{value.course_id}</p>
                                                    <p className="review-counts">100 reviews</p>
