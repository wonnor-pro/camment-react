...
class MobilePostForm extends React.Component {
        ...
        <div className={"mobile-main"}>
          ...
          <div className="mobile-post">
            <div className="mobile-course-info">
              ...
              <p className="mobile-review-counts">{this.state.course.num_posts} reviews</p>
              <StyledRating
                name="score"
                ...
                readOnly
              />
              <p className="mobile-course-title">{this.state.course.name}</p>
              <a className="mobile-course-desc" href={this.state.course.link}>Course Syllabus</a>
            </div>
            <div className="mobile-post-entry">
              <h3>Course Review</h3>
            </div>
            <div className="mobile-disclaimer"> Please be kindly noted that the course syllabus and lecturers may vary
              from year
              to year.
...
class MobileCommentFormBase extends React.Component {
